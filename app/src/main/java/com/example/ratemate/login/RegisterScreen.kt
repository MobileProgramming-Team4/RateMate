...
//        Divider()
        ...
        Scaffold(
            topBar = {
                CommonTopAppBar(title = "Sign Up", onNavigateBack = { navController.navigate("Start") }, true)
            }
        ) { paddingValues ->
            Column(
                modifier = Modifier
                ...
                Row {
                    OutlinedTextField(
                        ...
                        trailingIcon = {
                            ...
                            val description =
                                if (passwordVisibility2) "Hide password" else "Show password"
                ...
                Button(
                    onClick = {
                        if (userMail.isEmpty()) {
                            ...
                            Toast.makeText(context, "비밀번호는 6자 이상이어야 합니다.", Toast.LENGTH_SHORT)
                                .show()
